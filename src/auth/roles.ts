...
export type Role = 'admin' | 'doctor' | 'nurse' | 'pharmacist' | 'volunteer' | 'guest' | 'auditor' | 'lead_clinician'
...
export function canApproveConflict(role: Role, phiSensitivity: 'none' | 'low' | 'medium' | 'high'): boolean {
