    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Enroll existing patients in the patient portal. Patients must have email or phone number.
        </p>
      </div>

      {results && (
        <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h3 className="font-semibold text-blue-900 mb-2">Enrollment Results</h3>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              {processing ? 'Enrolling...' : `Enroll ${selectedPatients.size} Patients`}
            </button>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="p-8 text-center text-gray-500">
            No eligible patients found. All patients with contact information are already enrolled.
          </div>
        ) : (
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-yellow-800 space-y-1 list-disc list-inside">
          ...
          <li>Patients can login using their email/phone and OTP verification</li>
