...
export default function EmailDiagnostics() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Email System Diagnostics</h1>
        ...
        <div className="card bg-white border-2 border-gray-200">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-medium text-gray-900">Edge Function</h3>
              <p className="text-xs text-gray-600 mt-1">send-otp-email is ACTIVE</p>
              <div className="mt-2">
      ...
      <div className="card bg-white mb-8">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Test Email Delivery</h2>
                ...
                {testResult.demo && (
                  <div className="mt-2 text-xs text-yellow-800">
                    ...
                    <ul className="list-disc list-inside mt-1 space-y-1">
                      ...
                      <li>OTP is logged to Supabase Edge Function logs instead</li>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-blue-800 space-y-3">
              <div>
                <p className="font-semibold mb-1">Step 1: Create Resend Account (Free)</p>
                <ol className="list-decimal list-inside space-y-1 ml-2">
                  <li>Visit <a href="https://resend.com" target="_blank" rel="noopener noreferrer" className="underline">resend.com</a></li>
              ...
              <div>
                ...
                <ol className="list-decimal list-inside space-y-1 ml-2">
                  ...
                  <li>Name: <code className="bg-blue-100 px-1 rounded">RESEND_API_KEY</code></li>
              ...
              <div>
                ...
                <p className="ml-2">Use the test button above to verify emails are being sent</p>
              </div>
      ...
      <div className="card bg-gray-50 mt-8">
        <h3 className="text-sm font-semibold text-gray-900 mb-3">Current System Status</h3>
        <div className="space-y-2 text-xs">
          <div className="flex items-center space-x-2">
            <CheckCircleIcon className="h-4 w-4 text-green-600 flex-shrink-0" />
            <span className="text-gray-700">Edge Function deployed and active</span>
          </div>
          <div className="flex items-center space-x-2">
            <CheckCircleIcon className="h-4 w-4 text-green-600 flex-shrink-0" />
            <span className="text-gray-700">Patient portal users table exists</span>
          </div>
          <div className="flex items-center space-x-2">
            <CheckCircleIcon className="h-4 w-4 text-green-600 flex-shrink-0" />
            <span className="text-gray-700">Kristopher's portal account created</span>
          </div>
          <div className="flex items-center space-x-2">
            <ExclamationTriangleIcon className="h-4 w-4 text-yellow-600 flex-shrink-0" />
            <span className="text-gray-700">Email API key not configured (demo mode)</span>
          </div>
        </div>
      </div>
    </div>
