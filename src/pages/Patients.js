...
export function Patients() {
    ...
    return (_jsxs("div", { className: "space-y-4 sm:space-y-6", children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-xl sm:text-2xl font-bold text-gray-900", children: "Patients" }), _jsx("p", { className: "text-sm sm:text-base text-gray-600", children: "Manage patient records and information" })] }), _jsxs(Link, { to: "/register", className: "btn-primary inline-flex items-center justify-center gap-2 w-full sm:w-auto", children: [_jsx(UserPlusIcon, { className: "h-5 w-5" }), _jsx("span", { children: "Register Patient" })] })] }), _jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", children: _jsx(MagnifyingGlassIcon, { className: "h-5 w-5 text-gray-400" }) }), _jsx("input", { type: "text", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "input-field pl-10", placeholder: "Search patients by name or phone..." })] }), _jsx("div", { className: "space-y-4", children: filteredPatients.length === 0 ? (_jsxs("div", { className: "text-center py-12", children: [_jsx(UserIcon, { className: "h-12 w-12 mx-auto text-gray-400 mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: searchQuery ? 'No patients found' : 'No patients registered' }), _jsx("p", { className: "text-gray-600 mb-6", children: searchQuery
                                ? 'Try adjusting your search terms'
                                : 'Get started by registering your first patient' }), !searchQuery && (_jsx(Link, { to: "/register", className: "btn-primary", children: "Register Patient" }))] })) : (filteredPatients.map((patient) => (_jsx("div", { className: "card hover:shadow-md transition-shadow cursor-pointer active:bg-gray-50 p-4 sm:p-6", onClick: () => navigate(`/patients/${patient.id}`), children: _jsxs("div", { className: "flex items-center gap-3 sm:gap-4", children: [_jsx("div", { className: "flex-shrink-0", children: patient.photoUrl ? (_jsx("img", { src: patient.photoUrl, alt: `${patient.givenName} ${patient.familyName}`, className: "w-12 h-12 sm:w-16 sm:h-16 rounded-full object-cover" })) : (_jsx("div", { className: "w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gray-200 flex items-center justify-center", children: _jsxs("span", { className: "text-lg sm:text-xl font-medium text-gray-600", children: [patient.givenName[0], patient.familyName[0]] }) })) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center space-x-3 mb-2", children: [_jsxs("h3", { className: "text-lg font-medium text-gray-900 truncate", children: [patient.givenName, " ", patient.familyName] }), _jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800", children: patient.sex })] }), _jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-1 sm:space-y-0 text-sm text-gray-600", children: [_jsx("div", { className: "flex items-center space-x-1", children: _jsxs("span", { children: ["Age: ", getPatientAge(patient.dob)] }) }), _jsxs("div", { className: "flex items-center space-x-1", children: [_jsx(PhoneIcon, { className: "h-4 w-4" }), _jsx("span", { children: patient.phone })] }), _jsxs("div", { className: "flex items-center space-x-1", children: [_jsx(MapPinIcon, { className: "h-4 w-4" }), _jsxs("span", { children: [patient.state, ", ", patient.lga] })] })] })] }), _jsxs("div", { className: "flex-shrink-0 text-right", children: [_jsx("p", { className: "text-xs text-gray-500", children: "ID" }), _jsx("p", { className: "text-sm font-mono text-gray-700", children: patient.id.slice(-8).toUpperCase() })] })] }) }, patient.id)))) })] }));
}
