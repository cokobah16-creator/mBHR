...
export function Vitals() {
    ...
    if (!visit || !patient) {
        return (_jsxs("div", { className: "text-center py-12", children: [_jsx(HeartIcon, { className: "h-12 w-12 mx-auto text-gray-400 mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "Visit not found" }), _jsx("p", { className: "text-gray-600 mb-6", children: "The visit you're looking for doesn't exist." }), _jsx("button", { onClick: () => navigate('/queue'), className: "btn-primary", children: "Back to Queue" })] }));
    }
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center space-x-4", children: [_jsx("button", { onClick: () => navigate('/queue'), className: "p-2 rounded-lg hover:bg-gray-100 transition-colors touch-target", children: _jsx(ArrowLeftIcon, { className: "h-6 w-6 text-gray-600" }) }), _jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Record Vital Signs" }), _jsxs("p", { className: "text-gray-600", children: ["Patient: ", patient.givenName, " ", patient.familyName] })] })] }), _jsx("div", { className: "card", children: _jsxs("div", { className: "flex items-center space-x-4", children: [patient.photoUrl ? (_jsx("img", { src: patient.photoUrl, alt: `${patient.givenName} ${patient.familyName}`, className: "w-16 h-16 rounded-full object-cover" })) : (_jsx("div", { className: "w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center", children: _jsxs("span", { className: "text-xl font-medium text-gray-600", children: [patient.givenName[0], patient.familyName[0]] }) })), _jsxs("div", { children: [_jsxs("h3", { className: "text-lg font-medium text-gray-900", children: [patient.givenName, " ", patient.familyName] }), _jsxs("p", { className: "text-sm text-gray-600", children: ["Visit ID: ", visit.id.slice(-8).toUpperCase()] })] })] }) }), _jsx(VitalsForm, { patientId: patient.id, visitId: visit.id, onSuccess: handleSuccess, onCancel: handleCancel })] }));
}
