...
export async function resolveConflict(conflict, strategy, manualResolution, localData, remoteData) {
    ...
    if (strategy === 'keep-local') {
        ...
        const resolvedData = { id: conflict.entityId };
...
function mapRemoteToLocal(remoteData, entityType) {
    const fieldMaps = {
        patients: {
