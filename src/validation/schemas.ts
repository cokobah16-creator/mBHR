...
export const patientSchema = z
  ...
  .refine(
    ...
    {
      message:
        "You must accept the terms and conditions to enable portal access",
      path: ["termsAccepted"],
    },
  )
  .refine(
    ...
    {
      message:
        "Portal access requires at least a phone number or email address",
      path: ["email"],
    },
  );
...
export const vitalsSchema = z
  .object({
    ...
    pulseBpm: z
      ...
      .max(200, "Pulse must be under 200 bpm")
      .optional(),
    systolic: z
      .number()
      .min(60, "Systolic BP must be at least 60")
      .max(250, "Systolic BP must be under 250")
      .optional(),
    diastolic: z
      .number()
      .min(30, "Diastolic BP must be at least 30")
      .max(150, "Diastolic BP must be under 150")
      .optional(),
    spo2: z
      .number()
...
export type PrescriptionLineFormData = z.infer<typeof prescriptionLineSchema>;
