...
export default function VitalsPrecision() {
    ...
    if (!gameStarted) {
        return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(HeartIcon, { className: "h-8 w-8 text-primary" }), _jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Vitals Precision" }), _jsx("p", { className: "text-gray-600", children: "Test your ability to identify abnormal vital signs" })] })] }), _jsx("div", { className: "card max-w-2xl mx-auto", children: _jsxs("div", { className: "text-center py-8", children: [_jsx(HeartIcon, { className: "h-16 w-16 mx-auto text-green-500 mb-4" }), _jsx("h2", { className: "text-xl font-bold text-gray-900 mb-4", children: "Ready to Start?" }), _jsxs("div", { className: "space-y-4 text-left max-w-md mx-auto mb-6", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-blue-600 font-semibold text-sm", children: "1" }) }), _jsxs("p", { className: "text-gray-700", children: ["Review ", vitalCases.length, " patient scenarios"] })] }), _jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-blue-600 font-semibold text-sm", children: "2" }) }), _jsx("p", { className: "text-gray-700", children: "Identify normal vs abnormal vital signs" })] }), _jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-blue-600 font-semibold text-sm", children: "3" }) }), _jsx("p", { className: "text-gray-700", children: "Earn tokens based on accuracy and speed" })] })] }), _jsx("div", { className: "bg-green-50 border border-green-200 rounded-lg p-4 mb-6", children: _jsxs("div", { className: "text-sm text-green-800", children: [_jsx("div", { className: "font-medium mb-1", children: "\uD83D\uDCA1 Scoring:" }), _jsxs("ul", { className: "text-xs space-y-1 text-green-700", children: [_jsx("li", { children: "\u2022 Base: 8 tokens" }), _jsx("li", { children: "\u2022 Accuracy bonus: up to +30%" }), _jsx("li", { children: "\u2022 Speed bonus: +10% if time remaining" }), _jsx("li", { children: "\u2022 Streak bonus: +20% for 5+ correct in a row" })] })] }) }), _jsx("button", { onClick: startGame, className: "btn-primary", children: "Start Vitals Precision" })] }) })] }));
    }
    if (!currentCase)
        return null;
    const caseMetrics = Object.keys(currentCase.vitals);
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(HeartIcon, { className: "h-8 w-8 text-primary" }), _jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Vitals Precision" }), _jsxs("p", { className: "text-gray-600", children: ["Case ", caseIndex + 1, " of ", vitalCases.length] })] })] }), _jsxs("div", { className: "flex items-center space-x-6", children: [_jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "text-2xl font-bold text-primary", children: [sessionStats.correct, "/", sessionStats.total] }), _jsx("div", { className: "text-sm text-gray-600", children: "Correct" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-2xl font-bold text-orange-600", children: sessionStats.streak }), _jsx("div", { className: "text-sm text-gray-600", children: "Streak" })] }), _jsxs("div", { className: "text-center flex items-center space-x-1", children: [_jsx(ClockIcon, { className: "h-5 w-5 text-red-500" }), _jsx("div", { className: "text-xl font-bold text-red-600", children: formatTime(timeLeft) })] })] })] }), _jsx("div", { className: "w-full bg-gray-200 rounded-full h-2", children: _jsx("div", { className: "bg-primary h-2 rounded-full transition-all duration-300", style: { width: `${progress}%` } }) }), _jsxs("div", { className: "card max-w-4xl mx-auto", children: [_jsxs("div", { className: "mb-6", children: [_jsx("h2", { className: "text-xl font-bold text-gray-900 mb-2", children: "Patient Scenario" }), _jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-4", children: [_jsxs("p", { className: "text-blue-800", children: [_jsx("strong", { children: "Age:" }), " ", currentCase.patientAge, " years old \u2022", _jsx("strong", { children: "Sex:" }), " ", currentCase.patientSex === 'M' ? 'Male' : 'Female'] }), _jsx("p", { className: "text-blue-700 mt-2", children: currentCase.scenario })] })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: Object.entries(currentCase.vitals).map(([metric, value]) => {
                            ...
                            return (_jsxs("div", { className: `border rounded-lg p-4 transition-all ${answered
                                    ...
                                    : 'border-gray-200 hover:border-gray-300'}`, children: [_jsxs("div", { className: "text-center mb-4", children: [_jsx("h3", { className: "font-medium text-gray-900", children: metricLabels[metric] }), _jsxs("div", { className: "text-3xl font-bold text-primary mt-2", children: [value, _jsx("span", { className: "text-lg text-gray-600 ml-1", children: metricUnits[metric] })] })] }), answered ? (_jsxs("div", { className: "flex items-center justify-center space-x-2", children: [answered === 'normal' ? (_jsx(CheckCircleIcon, { className: "h-5 w-5 text-green-600" })) : (_jsx(XCircleIcon, { className: "h-5 w-5 text-red-600" })), _jsx("span", { className: "text-sm font-medium capitalize text-gray-700", children: answered })] })) : (_jsxs("div", { className: "flex space-x-2", children: [_jsx("button", { onClick: () => submitAnswer(metric, 'normal'), className: "flex-1 bg-green-100 text-green-800 py-2 px-3 rounded-lg hover:bg-green-200 transition-colors text-sm font-medium", children: "Normal" }), _jsx("button", { onClick: () => submitAnswer(metric, 'abnormal'), className: "flex-1 bg-red-100 text-red-800 py-2 px-3 rounded-lg hover:bg-red-200 transition-colors text-sm font-medium", children: "Abnormal" })] }))] }, metric));
