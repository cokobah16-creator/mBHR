        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Test your ability to identify abnormal vital signs
            </p>
          </div>
        </div>
            ...
            <div className="space-y-4 text-left max-w-md mx-auto mb-6">
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-700">
                  Review {vitalCases.length} patient scenarios
                </p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                ...
                <p className="text-gray-700">
                  Identify normal vs abnormal vital signs
                </p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                ...
                <p className="text-gray-700">
                  Earn tokens based on accuracy and speed
                </p>
              </div>
            </div>
