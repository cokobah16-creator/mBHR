...
import type { ClinicalAlert, PatientRiskProfile, MedicationAdherenceScore } from '@/services/clinicalDecisionSupport'
import { db } from '@/db'
...
export function ClinicalInsightsDashboard() {
  ...
  const [highRiskPatients, setHighRiskPatients] = useState<Array<{ patientId: string, name: string, profile: PatientRiskProfile }>>([])
  const [loading, setLoading] = useState(true)
  const [selectedTab, setSelectedTab] = useState<'alerts' | 'risk' | 'adherence'>('alerts')
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <p className="text-gray-600">
          AI-powered insights to help clinicians make better decisions and identify high-risk patients
        </p>
      </div>
        ...
        <div className="p-6">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium uppercase ${getSeverityColor(alert.severity)}`}>
                              {alert.severity}
                            </span>
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span className={`h-2 w-2 rounded-full ${getRiskColor(profile.overallRisk)}`}></span>
                      ...
                      <div className="space-y-2">
                          ...
                          <div className="space-y-1">
                            {profile.riskFactors.map((rf, idx) => (
                              <div key={idx} className="text-sm text-gray-600 flex items-start gap-2">
                                ...
                                <span><strong>{rf.factor}:</strong> {rf.description}</span>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        {profile.predictedComplications.length > 0 && (
                          <div>
                            <h5 className="text-sm font-medium text-gray-700 mb-1">Predicted Complications:</h5>
          ...
          {selectedTab === 'adherence' && (
            <div className="text-center py-12 text-gray-500">
              ...
              <p className="text-sm">
                This feature analyzes patient factors to predict medication adherence risks.
              </p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="text-blue-800">
              This AI-powered system analyzes patient vitals, medical history, and risk factors to provide
              intelligent alerts and recommendations. It helps identify high-risk patients early and
