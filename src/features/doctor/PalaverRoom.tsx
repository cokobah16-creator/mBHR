...
export function PalaverRoom({ onClose, isPanel = false }: PalaverRoomProps) {
  ...
  const [selectedMessage, setSelectedMessage] = useState<PalaverMessage | null>(
    null,
  );
  ...
  const handleReply = () => {
    ...
    const otherPerson =
      selectedMessage.sender_id === currentUser.id
        ? {
            id: selectedMessage.recipient_id,
            name: selectedMessage.recipient_name,
          }
              ...
              <div className="space-y-4">
                ...
                {messages.length === 0 ? (
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p>No messages yet</p>
                    <p className="text-sm">
                      Messages from colleagues will appear here
                    </p>
                  </div>
                ) : (
                  <div className="space-y-2">
            ...
            {viewMode === "broadcast" && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Send a message to all staff in a specific role
                </p>
