                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center">
                        ...
                        {order.testCode && (
                          <span className="ml-2 text-sm text-gray-500">({order.testCode})</span>
                        )}
                      </div>
                      ...
                      <div className="mt-1 text-sm text-gray-500">
                        Ordered: {order.orderedAt ? new Date(order.orderedAt).toLocaleString() : 'N/A'}
                      </div>
                    </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-gray-900">CRITICAL RESULT</span>
                    </div>
                    ...
                    {result.notes && (
                      <div className="mt-1 text-sm text-gray-600">Notes: {result.notes}</div>
                    )}
                    <div className="mt-1 text-sm text-gray-500">
                      Result Date: {result.resultDate ? new Date(result.resultDate).toLocaleString() : 'N/A'}
                    </div>
                  </div>
                  {!result.reviewedBy && (
                    <button
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200 flex items-center justify-between">
              <div>
                <h3 className="text-lg font-medium text-gray-900">Enter Lab Result</h3>
                <p className="mt-1 text-sm text-gray-500">{selectedOrder.testName}</p>
              </div>
              <button
                onClick={() => {
                  setShowResultForm(false)
            ...
            <form onSubmit={handleSubmit(onSubmitResult)} className="px-4 py-5 sm:p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {errors.resultValue && (
                    <p className="mt-1 text-sm text-red-600">{errors.resultValue.message}</p>
                  )}
                </div>
