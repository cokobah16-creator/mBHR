                                                                    ...
                                                                    await db.inventory.update(selectedMedication, {
                                                                        ...
                                                                        try: {
                                                                            ...
                                                                            const: completeCounseling = () => {
                                                                                ...
                                                                                onSuccess?.();
                                                                                if (showCounseling) {
                                                                                    _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(InformationCircleIcon, { className: "h-8 w-8 text-primary" }), _jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900", children: "Patient Counseling" }), _jsx("p", { className: "text-gray-600", children: "Review medication instructions with patient" })] })] }), _jsx("div", { className: "card max-w-2xl mx-auto", children: _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-4", children: [_jsx("h3", { className: "font-medium text-blue-800 mb-2", children: "Medication Dispensed" }), _jsxs("p", { className: "text-blue-700", children: [_jsx("strong", { children: medications.find(m => m.id === selectedMedication)?.itemName }), " \u00D7 ", requestedQty] }), _jsx("strong", { children: "Dosage:" }), " ", dosage, _jsx("strong", { children: "Instructions:" }), " ", directions] }), _jsxs("div", { className: "space-y-4", children: [_jsx("h3", { className: "text-lg font-medium text-gray-900", children: "Counseling Checklist" }), _jsx("div", { className: "space-y-3", children: [
                                                                                                                    ...
                                                                                                                    ].map((item, index) => (_jsxs("label", { className: "flex items-center space-x-3", children: [_jsx("input", { type: "checkbox", className: "h-5 w-5 text-primary focus:ring-primary border-gray-300 rounded" }), _jsx("span", { className: "text-gray-700", children: item })] }, index))) }), _jsx("div", { className: "bg-green-50 border border-green-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(CheckCircleIcon, { className: "h-5 w-5 text-green-600" }), _jsx("span", { className: "text-green-800 font-medium", children: "SMS reminder scheduled for tomorrow at 9:00 AM" }), _jsx("button", { onClick: completeCounseling, className: "btn-primary w-full", children: "Complete Dispensing" }), "const totalAvailable = allocation.reduce((sum, a) => sum + a.qty, 0) const isShortfall = totalAvailable ", _jsx("requestedQty", { const: true, hasExpiredBatches: true, allocation: true }), ".some(a => a.daysUntilExpiry ", _jsx(, {}), " 0) const hasMajorInteractions = interactions.some(i => i.severity === 'major') return (", _jsx("div", { className: "space-y-6", children: _jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(BeakerIcon, { className: "h-8 w-8 text-primary" }), _jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900", children: "Enhanced Pharmacy" }), _jsx("p", { className: "text-gray-600", children: "FEFO dispensing with interaction checking" }), currentMedications.length > 0 && (_jsx("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-center space-x-2 mb-2", children: [_jsx(InformationCircleIcon, { className: "h-5 w-5 text-blue-600" }), _jsx("h3", { className: "font-medium text-blue-800", children: "Current Medications" }), _jsxs("div", { className: "flex flex-wrap gap-2", children: [currentMedications.map((med, index) => (_jsx("span", { className: "px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-sm", children: med }, index))), ")}", interactions.length > 0 && (_jsx("div", { className: "space-y-3", children: interactions.map((interaction, index) => (_jsx("div", { className: `border rounded-lg p-4 ${getInteractionSeverityColor(interaction.severity)}`, children: _jsxs("div", { className: "flex items-center space-x-2 mb-2", children: [_jsx(ShieldExclamationIcon, { className: "h-5 w-5" }), _jsxs("h3", { className: "font-medium", children: [interaction.severity.toUpperCase(), " Drug Interaction"] }), _jsx("p", { className: "text-sm mb-2", children: interaction.description }), _jsxs("p", { className: "text-sm font-medium", children: ["Action: ", interaction.action] }), "))}", _jsx("div", { className: "card", children: _jsxs("div", { className: "space-y-6", children: [_jsxs("label", { className: "block text-lg font-medium text-gray-700 mb-3", children: [t('pharmacy.medication'), " *"] }), _jsxs("select", { value: selectedMedication, onChange: (e) => setSelectedMedication(e.target.value), className: "input-field text-lg", children: [_jsx("option", { value: "", children: t('simple.selectMedication') }), medications.map((med) => (_jsxs("option", { value: med.id, children: [med.itemName, " (", med.onHandQty, " ", med.unit, " ", t('common.available'), ")"] }, med.id)))] }), t('pharmacy.quantity'), " *", _jsxs("div", { className: "flex items-center justify-center space-x-4", children: [_jsx("button", { type: "button", onClick: () => setRequestedQty(Math.max(1, requestedQty - 1)), className: "w-12 h-12 bg-red-100 text-red-600 rounded-full flex items-center justify-center hover:bg-red-200 touch-target-large", children: _jsx("span", { className: "text-xl font-bold", children: "\u2212" }) }), _jsxs("div", { className: "text-center", children: [_jsx("input", { type: "number", value: requestedQty, onChange: (e) => setRequestedQty(Math.max(1, parseInt(e.target.value) || 1)), min: "1", className: "w-24 text-3xl font-bold text-center border-2 border-gray-300 rounded-lg py-2" }), requestedQty <= 10 && (_jsx("div", { className: "flex justify-center gap-1 mt-2", children: Array.from({ length: requestedQty }, (_, i) => (_jsx("div", { className: "w-3 h-3 bg-primary rounded-full" }, i))) })), "onClick=", () => setRequestedQty(requestedQty + 1), "className=\"w-12 h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center hover:bg-green-200 touch-target-large\"", _jsx("span", { className: "text-xl font-bold", children: "+" }), allocation.length > 0 && (_jsxs("div", { children: [_jsx("h3", { className: "text-lg font-medium text-gray-700 mb-3", children: "FEFO Batch Allocation" }), isShortfall && (_jsxs("div", { className: "bg-red-50 border border-red-200 rounded-lg p-4 mb-4", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(ExclamationTriangleIcon, { className: "h-5 w-5 text-red-600" }), _jsxs("span", { className: "text-sm text-red-800", children: ["Insufficient stock: ", totalAvailable, " available, ", requestedQty, " requested"] })] }), ")}", hasExpiredBatches && (_jsx(XCircleIcon, { className: "h-5 w-5 text-red-600" })), "Cannot dispense: Some batches have expired", allocation.map((alloc, index) => {
                                                                                                                                                                                                                                    const expiryStatus = getExpiryStatus(alloc.daysUntilExpiry);
                                                                                                                                                                                                                                    const StatusIcon = expiryStatus.icon;
                                                                                                                                                                                                                                    return (_jsxs("div", { className: "border rounded-lg p-4", children: [_jsx("div", { className: "flex items-center justify-between", children: _jsxs("div", { children: [_jsxs("div", { className: "font-medium text-gray-900", children: ["Batch ", index + 1, ": ", alloc.lotNumber] }), _jsxs("div", { className: "text-sm text-gray-600", children: ["Quantity: ", alloc.qty, " \u2022 Expires: ", formatNigerianDate(alloc.expiryDate), "(", alloc.daysUntilExpiry, " days)"] }), _jsxs("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${expiryStatus.color}`, children: [_jsx(StatusIcon, { className: "h-3 w-3 mr-1" }), expiryStatus.status] })] }) }), ") })} )}", _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs("label", { className: "block text-lg font-medium text-gray-700 mb-3", children: [t('pharmacy.dosage'), " *"] }), _jsx("input", { type: "text", value: dosage, onChange: (e) => setDosage(e.target.value), className: "input-field text-lg", placeholder: t('simple.dosageExample') }), t('pharmacy.directions'), " *", _jsx("textarea", { value: directions, onChange: (e) => setDirections(e.target.value), rows: 3, placeholder: t('simple.directionsExample'), ..., ...(hasExpiredBatches || hasMajorInteractions) && (_jsxs("div", { className: "bg-red-50 border border-red-200 rounded-lg p-4", children: [_jsx(ShieldExclamationIcon, { className: "h-5 w-5 text-red-600" }), _jsx("h3", { className: "font-medium text-red-800", children: "Safety Alert" }), _jsxs("ul", { className: "text-sm text-red-700 space-y-1", children: [hasExpiredBatches && _jsx("li", { children: "\u2022 Cannot dispense expired medication" }), hasMajorInteractions && _jsx("li", { children: "\u2022 Major drug interaction detected" })] }), _jsxs("div", { className: "flex space-x-4 pt-6", children: [_jsx("button", { onClick: handleDispense, disabled: !canDispense() || loading, className: "btn-primary flex-1 disabled:opacity-50 disabled:cursor-not-allowed", ...loading ? t('pharmacy.dispensing') : 'Dispense & Counsel', ...onCancel && (onClick = { onCancel }), className: "btn-secondary", ...t('action.cancel') }), ")}"] }), ")"] })) })] })] }, alloc.batchId));
                                                                                                                                                                                                                                })] }))] }))] })] })] }) })] }) }, index))) }))] })] }) }))] })] }) })] }) })] })] }) })] });
                                                                                }
                                                                            }
                                                                        }
