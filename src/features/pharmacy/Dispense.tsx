...
export default function Dispense() {
  ...
  const chosenItem = chosenLine
    ? items.find((i) => i.id === chosenLine.itemId)
    : null;
  ...
  async function doDispense() {
    ...
    if (batch.qtyOnHand < chosenLine.qty) {
      alert(
        `❌ Insufficient stock. Available: ${batch.qtyOnHand}, Required: ${chosenLine.qty}`,
      );
      return;
    }
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    {chosenItem?.medName} {chosenItem?.strength}
                  </div>
                  <div>
                    <span className="font-medium">Quantity:</span>{" "}
                    {chosenLine?.qty} {chosenItem?.unit}
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t">
                <button
                  ...
                  disabled={
                    !selected || availableBatches.length === 0 || loading
                  }
                  onClick={doDispense}
                >
