...
export default function TicketIssuer() {
    ...
    async function handleAddToQueue() {
        ...
        try {
            const queueItem = await queueManagement.addToQueue(selectedPatient.id, stage, priority, currentUser.id);
