...
import { QueueListIcon, PlayIcon, CheckIcon, ClockIcon, UserGroupIcon } from '@heroicons/react/24/outline';
...
export default function QueueBoard() {
    ...
    return (_jsxs("div", { className: "p-4 space-y-6", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(QueueListIcon, { className: "h-8 w-8 text-primary" }), _jsx("h2", { className: "text-2xl font-bold text-gray-900", children: "Queue Management" })] }), _jsx("div", { className: "flex space-x-2 overflow-x-auto", children: STAGES.map(stage => {
