        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Export all patient records for population-level analysis
            </p>
          </div>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">
                This export includes data for all{" "}
                {patientCount.toLocaleString()} patients. Only authorized
                administrators should perform bulk exports. All exports are
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Bulk export complies with EHI Export requirements. Data is
                exported in NDJSON format with US Core 6.1.0 validation,
                supporting population health analytics and data migration.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setOptions({
                    ...options,
                    dateRange: e.target.value as typeof options.dateRange,
                  })
                }
            ...
            <div>
              ...
              >
                <option value={50}>
                  50 patients/batch (slower, less memory)
                </option>
                <option value={100}>100 patients/batch (balanced)</option>
                <option value={200}>
                  200 patients/batch (faster, more memory)
                </option>
              </select>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between text-sm mb-2">
              <span className="font-medium text-gray-700">
                Processing: {progress.processedPatients.toLocaleString()} /{" "}
                {progress.totalPatients.toLocaleString()} patients
              </span>
          ...
          <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <div className="mt-3 grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <span className="ml-2 font-medium">
                  {result.progress.processedPatients.toLocaleString()}
                </span>
              </div>
              <div>
            ...
            {result.validation && (
              <div className="mt-3 text-sm">
                ...
                <span
                  className={`ml-2 font-medium ${result.validation.valid ? "text-green-600" : "text-amber-600"}`}
                >
                  {result.validation.validResources}/
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-600">
                    {entry.patientCount.toLocaleString()} patients,{" "}
                    {entry.resourceCount.toLocaleString()} resources
                  </span>
                </div>
                {entry.error && (
