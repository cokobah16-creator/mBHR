...
export function AppointmentRequest() {
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your appointment request has been submitted successfully. Our team will review it and get back to you soon.
          </p>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Tell us when you'd like to visit and we'll schedule it for you</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="bg-white rounded-xl shadow-sm p-6 space-y-6">
        <div>
          ...
          {form.formState.errors.appointmentType && (
            <p className="mt-2 text-sm text-red-600">{form.formState.errors.appointmentType.message}</p>
          )}
        </div>

        <div className="border-t border-gray-200 pt-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Preferred Dates & Times</h3>
          <p className="text-sm text-gray-600 mb-4">
            Please provide up to 3 preferred dates to increase chances of getting an appointment that works for you.
          </p>

          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="preferredDate1" className="block text-sm font-medium text-gray-700 mb-2">
                  First Choice Date *
                </label>
                <input
                ...
                {form.formState.errors.preferredDate1 && (
                  <p className="mt-2 text-sm text-red-600">{form.formState.errors.preferredDate1.message}</p>
                )}
              </div>
              <div>
                <label htmlFor="preferredTime1" className="block text-sm font-medium text-gray-700 mb-2">
                  Preferred Time
                </label>
                <select
        ...
        <div className="border-t border-gray-200 pt-6">
          <div>
            ...
            {form.formState.errors.reason && (
              <p className="mt-2 text-sm text-red-600">{form.formState.errors.reason.message}</p>
            )}
          ...
          <div className="mt-4">
            ...
            {form.formState.errors.notes && (
              <p className="mt-2 text-sm text-red-600">{form.formState.errors.notes.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> This is a request, not a confirmed appointment. Our staff will review your request
            and contact you to confirm the appointment time.
          </p>
        </div>
