      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">BP, heart rate, temp, etc.</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Prescriptions & dispenses</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              />
              <div>
                <span className="font-medium text-gray-900">Clinical Notes</span>
            ...
            <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Known allergies & reactions</p>
              </div>
            </label>
          </div>
        </div>
        ...
        {!isOnline && (
          <p className="mt-3 text-sm text-center text-amber-600">
            Exporting from local device storage. Some records may not be fully synced.
          </p>
        )}
      </div>
