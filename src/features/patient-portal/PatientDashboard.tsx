...
export function PatientDashboard() {
  ...
  const loadDashboard = async () => {
    ...
    try {
      ...
      if (!portalUserStr) {
        logger.info(
          "No portal user found in localStorage - redirecting to login",
        );
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-xl shadow-sm p-6 text-white">
        ...
        <p className="text-teal-100 mb-4">
          Access your health data in a standardized format that you can share
          with any healthcare provider, import into health apps, or keep as a
          personal backup. Compliant with TEFCA Individual Access Services.
        </p>
