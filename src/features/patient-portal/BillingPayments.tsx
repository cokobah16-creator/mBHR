      ...
      const updatedBills = bills.map(bill => {
        if (bill.id === selectedBill.id) {
          ...
          return {
            ...
            status: newAmountPaid >= bill.amount ? 'paid' as const : 'partial' as const
          }
        }
        return bill
      })
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600 mt-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-green-600">₦{bill.amountPaid.toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="font-medium text-gray-500">Balance</p>
                      <p className="font-semibold text-red-600">₦{(bill.amount - bill.amountPaid).toLocaleString()}</p>
                    </div>
                  </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <p className="font-semibold text-gray-900">{selectedBill.description}</p>
              <p className="text-sm text-gray-600 mt-2">Amount Due</p>
              <p className="text-2xl font-bold text-gray-900">₦{(selectedBill.amount - selectedBill.amountPaid).toLocaleString()}</p>
            </div>
