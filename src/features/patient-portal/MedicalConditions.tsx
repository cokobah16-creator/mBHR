      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">Manage your health conditions and history</p>
          </div>
          <button
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewCondition({ ...newCondition, condition_name: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewCondition({ ...newCondition, diagnosed_date: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          {conditions.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-600">Add your medical conditions to keep your record updated</p>
            </div>
          ) : (
                ...
                <div key={condition.id} className="p-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="font-medium text-gray-900">{condition.condition_name}</h3>
                      {condition.diagnosed_date && (
                        <p className="text-sm text-gray-600 mt-1">
                          Diagnosed: {formatNigerianDate(condition.diagnosed_date)}
                        </p>
                      )}
                      {condition.notes && (
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> This information will be reviewed by your healthcare provider
            and may be used to update your official medical record.
          </p>
        </div>
      </div>
    </div>
