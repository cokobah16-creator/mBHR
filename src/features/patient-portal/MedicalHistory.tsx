    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">View your past visits and consultations</p>
          </div>
      ...
      {records.length === 0 && !loading ? (
        <div className="bg-white rounded-xl shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600">Your visit history will appear here once you have appointments.</p>
        </div>
      ) : (
                ...
                <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-4 mb-3 pl-15">
                      ...
                      {record.vitals.pulseBpm && (
                        <div className="text-sm">
                          ...
                          <span className="font-medium text-gray-900">{record.vitals.pulseBpm} bpm</span>
                        </div>
                      )}
                      {record.vitals.tempC && (
                        <div className="text-sm">
                          <span className="text-gray-600">Temp:</span>{' '}
                          <span className="font-medium text-gray-900">{record.vitals.tempC}°C</span>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {record.prescriptions && record.prescriptions.length > 0 && (
                    <div className="mt-3 pl-15">
                      <p className="text-sm text-gray-600 mb-1">Medications prescribed:</p>
