    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Virtual video consultations with your healthcare providers</p>
          </div>
          <button
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm p-6 border border-blue-100">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-lg">Benefits of Telehealth</h3>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900 text-lg">{appointment.providerName}</h3>
                          <p className="text-gray-600 text-sm">{appointment.providerSpecialty}</p>
                        </div>
                      ...
                      <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div className="flex items-center gap-2 text-gray-700">
                          ...
                          <span>{formatNigerianDate(appointment.scheduledAt)}</span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-700">
                      ...
                      <div className="mt-3">
                        <p className="text-sm font-medium text-gray-700">Reason: {appointment.reason}</p>
                        {appointment.notes && (
                      ...
                      {canJoin && (
                        <div className="mt-4 bg-green-50 border border-green-200 rounded-lg p-4">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="font-semibold text-green-900">Your appointment is ready!</p>
                              <p className="text-sm text-green-700">Click below to join the video call</p>
                            </div>
                            <button
      ...
      {upcomingAppointments.length === 0 && pastAppointments.length === 0 && (
        <div className="bg-white rounded-xl shadow-sm p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">No Telehealth Appointments</h3>
          <p className="text-gray-600 mb-6">Request your first virtual consultation with a healthcare provider</p>
          <button
            onClick={() => setShowRequestModal(true)}
      ...
      {showRequestModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Request Telehealth Appointment</h2>
