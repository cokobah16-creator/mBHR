...
export function UpdatePHR() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Update Personal Health Record</h1>
          <p className="mt-2 text-gray-600">
            Keep your health information up to date. Changes are saved immediately.
          </p>
        </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  {editingField === field.key ? (
                    ...
                    <p className="text-gray-900">{field.value || 'Not provided'}</p>
                  )}
                </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> Some fields like Date of Birth cannot be changed here. Please
            contact clinic staff if you need to update protected information.
          </p>
        </div>
      </div>
    </div>
