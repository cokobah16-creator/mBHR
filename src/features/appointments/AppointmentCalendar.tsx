...
export function AppointmentCalendar({ providerId, patientId, createdBy }: AppointmentCalendarProps) {
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      {appointment.reason && (
                        <div className="mt-1 text-sm text-gray-600">{appointment.reason}</div>
                      )}
                    </div>
