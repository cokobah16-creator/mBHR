...
export function PatientFlagsPanel({ org_id, site_id, event_id, station }: PatientFlagsPanelProps) {
  ...
  if (flags.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow-sm p-4">
        ...
        <p className="text-sm text-gray-500">No pending flags for your station</p>
      </div>
    )
  }
                ...
                {flag.context && Object.keys(flag.context).length > 0 && (
                  <div className="mt-2 text-xs">
                    <details className="cursor-pointer">
                      <summary className="font-medium">Additional Context</summary>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600 mb-2">
                <strong>Flag:</strong> {selectedFlag.flag_type.replace(/_/g, ' ')}
              </p>
