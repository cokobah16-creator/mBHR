...
export function VitalsForm({ patientId, visitId, onSuccess, onCancel }) {
    ...
    const { register, handleSubmit, watch, control, formState: { errors } } = methods;
