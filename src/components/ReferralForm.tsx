        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) => setFormData({ ...formData, referral_type: e.target.value as Referral['referral_type'] })}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setFormData({ ...formData, urgency: e.target.value as Referral['urgency'] })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              required
            >
