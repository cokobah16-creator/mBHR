    ...
    const steps = [
        ...
        },
        {
            ...
            component: (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsxs("label", { className: "block text-lg font-medium text-gray-700 mb-3", children: [t('patient.state'), " *"] }), _jsxs("select", { value: formData.state, onChange: (e) => {
                                ...
                                }, className: "input-field text-xl", children: [_jsx("option", { value: "", children: t('simple.selectState') }), NIGERIAN_STATES.map((state) => (_jsx("option", { value: state, children: state }, state)))] })] }), _jsxs("div", { children: [_jsxs("label", { className: "block text-lg font-medium text-gray-700 mb-3", children: [t('patient.lga'), " *"] }), _jsxs("select", { value: formData.lga, onChange: (e) => setFormData(prev => ({ ...prev, lga: e.target.value })), className: `input-field text-xl ${!formData.state ? 'bg-gray-100 cursor-not-allowed' : ''}`, disabled: !formData.state || (LGAS_BY_STATE[formData.state] || []).length === 0, children: [_jsx("option", { value: "", children: !formData.state
                                            ? t('simple.selectState') + ' first'
                                            : (LGAS_BY_STATE[formData.state] || []).length === 0
                                                ? 'No LGAs available'
                                                : t('simple.selectLGA') }), (LGAS_BY_STATE[formData.state] || []).map((lga) => (_jsx("option", { value: lga, children: lga }, lga)))] }), formData.state && (LGAS_BY_STATE[formData.state] || []).length > 0 && (_jsxs("p", { className: "text-gray-500 text-sm mt-2", children: [(LGAS_BY_STATE[formData.state] || []).length, " LGAs available"] }))] })] }))
        }
    ];
