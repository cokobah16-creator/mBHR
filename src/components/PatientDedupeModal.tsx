            ...
            const getMatchLabel = (score) => {
                ...
                const formatField = (value) => {
                    ...
                    return (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50", children: _jsx("div", { className: "bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto", children: _jsxs("div", { className: "p-6", children: [_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(ExclamationTriangleIcon, { className: "h-8 w-8 text-yellow-600" }), _jsxs("div", { children: [_jsx("h2", { className: "text-xl font-bold text-gray-900", children: "Potential Duplicate Patient" }), _jsx("p", { className: "text-gray-600", children: "We found similar patients. Please review and choose an action." })] })] }), _jsx("button", { onClick: onCancel, className: "p-2 rounded-lg hover:bg-gray-100 transition-colors", children: _jsx(XMarkIcon, { className: "h-6 w-6 text-gray-600" }) })] }), _jsxs("div", { className: "mb-6", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-3", children: "New Patient Being Registered" }), _jsx("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-4", children: _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 text-sm", children: [_jsxs("div", { children: [_jsx("span", { className: "font-medium text-blue-800", children: "Name:" }), _jsxs("div", { className: "text-blue-700", children: [newPatient.givenName, " ", newPatient.familyName] })] }), _jsx("span", { className: "font-medium text-blue-800", children: "Phone:" }), _jsx("div", { className: "text-blue-700", children: formatField(newPatient.phone) }), _jsx("span", { className: "font-medium text-blue-800", children: "DOB:" }), _jsx("div", { className: "text-blue-700", children: formatField(newPatient.dob) }), _jsx("span", { className: "font-medium text-blue-800", children: "Sex:" }), _jsx("div", { className: "text-blue-700", children: formatField(newPatient.sex) }), _jsxs("h3", { className: "text-lg font-semibold text-gray-900 mb-3", children: ["Existing Patients (", candidates.length, " found)"] }), _jsx("div", { className: "space-y-3", children: candidates.map((candidate) => {
                                                                ...
                                                                return (_jsx("div", { className: `border rounded-lg p-4 cursor-pointer transition-all ${isSelected
                                                                        ? 'border-primary bg-primary/5 ring-2 ring-primary/20'
                                                                        : 'border-gray-200 hover:border-gray-300'}`, onClick: () => setSelectedWinner(candidate.id), children: _jsxs("div", { className: "flex items-start justify-between mb-3", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsx("div", { className: "w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center", children: _jsx(UserIcon, { className: "h-5 w-5 text-gray-500" }) }), _jsxs("div", { children: [_jsxs("h4", { className: "font-medium text-gray-900", children: [candidate.givenName, " ", candidate.familyName] }), _jsxs("p", { className: "text-sm text-gray-600", children: ["ID: ", candidate.id.slice(-8).toUpperCase()] })] }), _jsxs("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${matchInfo.color}`, children: [matchInfo.label, " (", matchScore, "%)"] })] }), _jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 text-sm", children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(PhoneIcon, { className: "h-4 w-4 text-gray-400" }), _jsx("span", { className: candidate.phone === newPatient.phone ? 'font-medium text-green-700' : 'text-gray-600', children: formatField(candidate.phone) }), _jsx(CalendarIcon, { className: "h-4 w-4 text-gray-400" }), _jsxs("span", { className: candidate.dob === newPatient.dob ? 'font-medium text-green-700' : 'text-gray-600', children: [formatField(candidate.dob), _jsx("span", { className: "text-gray-400", children: "Sex:" }), _jsxs("span", { className: candidate.sex === newPatient.sex ? 'font-medium text-green-700' : 'text-gray-600', children: [formatField(candidate.sex), _jsx(MapPinIcon, { className: "h-4 w-4 text-gray-400" }), _jsx("span", { className: "text-gray-600", children: candidate.state }), _jsxs("div", { className: "mt-2 text-xs text-gray-500", children: ["Registered: ", formatNigerianDate(candidate.createdAt)] }), ") })}", _jsxs("div", { className: "flex space-x-4", children: ["onClick=", () => onResolve('create_new'), "className=\"btn-secondary flex-1\" Create New Patient onClick=", handleMerge, "disabled=", !selectedWinner || loading, "className=\"btn-primary flex-1 disabled:opacity-50 disabled:cursor-not-allowed\"", loading ? 'Merging...' : 'Use Selected Patient', _jsx("div", { className: "mt-4 text-center", children: _jsx("p", { className: "text-xs text-gray-500", children: "Selecting an existing patient will link this registration to their record." }) })] })] }), ")"] })] }) })] }) }, candidate.id));
                                                            }) })] }) })] })] }) }) }));
                };
            };
        }
