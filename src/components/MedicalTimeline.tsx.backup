                        ...
                        if (vital.bmi) {
                            ...
                            consultations.forEach(consultation => {
                                ...
                                consultation.createdAt,
                                    title;
                                t('timeline.consultationCompleted'),
                                    details;
                                `${consultation.providerName} • ${consultation.provisionalDx.join(', ')}`,
                                    metadata;
                                {
                                ...
                                dispenses.forEach(dispense => {
                                    ...
                                    dispense.dispensedAt,
                                        title;
                                    t('timeline.medicationDispensed'),
                                        details;
                                    `${dispense.itemName} ${dispense.dosage} × ${dispense.qty}`,
                                        directions;
                                    dispense.directions,
                                        dispensedBy;
                            ...
                            if (loading) {
                                ...
                                return (_jsx("div", { className: `space-y-6 ${className}`, children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900", children: t('timeline.medicalHistory') }), _jsx("div", { className: "flex space-x-2", children: [
