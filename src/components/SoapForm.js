        ...
        const updateDiagnosis = (index, value) => {
            ...
            const onSubmit = async (data) => {
                ...
                try {
                    ...
                    setLoading(false);
                    return (_jsx("div", { className: "max-w-4xl mx-auto", children: _jsxs("div", { className: "card", children: [_jsxs("div", { className: "flex items-center space-x-3 mb-6", children: [_jsx(DocumentTextIcon, { className: "h-8 w-8 text-primary" }), _jsx("h2", { className: "text-2xl font-bold text-gray-900", children: "Consultation Notes" })] }), _jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-6", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Subjective (Patient's History) *" }), _jsx("textarea", { ...register('soapSubjective'), className: "input-field", rows: 4, placeholder: "Patient reports... Chief complaint, history of present illness, review of systems..." }), errors.soapSubjective && (_jsx("p", { className: "text-red-600 text-sm mt-1", children: errors.soapSubjective.message }))] }), "Objective (Physical Examination) *", ...register('soapObjective'), "placeholder=\"Physical examination findings, vital signs, laboratory results...\"", errors.soapObjective && (_jsx("p", { className: "text-red-600 text-sm mt-1", children: errors.soapObjective.message })) /* Assessment */, "Assessment (Clinical Impression) *", ...register('soapAssessment'), "rows=", 3, "placeholder=\"Clinical reasoning, differential diagnosis, problem list...\"", errors.soapAssessment && (_jsx("p", { className: "text-red-600 text-sm mt-1", children: errors.soapAssessment.message })) /* Plan */, "Plan (Treatment Plan) *", ...register('soapPlan'), "placeholder=\"Treatment plan, medications, follow-up instructions, patient education...\"", errors.soapPlan && (_jsx("p", { className: "text-red-600 text-sm mt-1", children: errors.soapPlan.message })) /* Provisional Diagnoses */, _jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Provisional Diagnoses" }), _jsxs("button", { type: "button", onClick: addDiagnosis, className: "flex items-center space-x-1 text-primary hover:text-primary/80 text-sm font-medium", children: [_jsx(PlusIcon, { className: "h-4 w-4" }), _jsx("span", { children: "Add Diagnosis" })] })] }), _jsxs("div", { className: "space-y-3", children: [diagnoses.map((diagnosis, index) => (_jsxs("div", { className: "flex items-center space-x-2", children: [_jsxs("span", { className: "text-sm font-medium text-gray-500 w-8", children: [index + 1, "."] }), _jsx("input", { type: "text", value: diagnosis, onChange: (e) => updateDiagnosis(index, e.target.value), className: "input-field flex-1", placeholder: "Enter diagnosis (e.g., Hypertension, Type 2 Diabetes)" }), diagnoses.length > 1 && (_jsx("button", { type: "button", onClick: () => removeDiagnosis(index), className: "text-red-600 hover:text-red-800 p-1 touch-target", children: _jsx(XMarkIcon, { className: "h-5 w-5" }) }))] }, index))), _jsxs("div", { className: "bg-gray-50 p-4 rounded-lg", children: [_jsxs("p", { className: "text-sm text-gray-600", children: [_jsx("strong", { children: "Provider:" }), " ", currentUser?.fullName || 'Unknown'] }), _jsx("strong", { children: "Date:" }), " ", formatNigerianDate(new Date()), _jsxs("div", { className: "flex space-x-4 pt-6", children: [_jsx("button", { type: "submit", disabled: loading, className: "btn-primary flex-1", children: loading ? 'Saving...' : 'Save Consultation' }), onCancel && (onClick = { onCancel }), "className=\"btn-secondary flex-1\" Cancel"] })] })] }), ")"] })] }) }));
                }
            };
        };
    };
