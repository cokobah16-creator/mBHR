...
export function mapVitalsToFHIR(vitals: LocalVitals, patientName?: string): FHIRObservation[] {
...
export function mapDispenseToFHIR(dispense: LocalDispense, patientName?: string): FHIRMedicationRequest {
  return {
...
export function mapVisitToFHIR(visit: LocalVisit, patientName?: string): FHIREncounter {
...
export function createBundle(
  resources: Array<{ resourceType: string; id?: string } & Record<string, unknown>>,
  baseUrl: string,
  total?: number,
): FHIRBundle {
  return {
...
export function createCapabilityStatement(baseUrl: string): FHIRCapabilityStatement {
  return {
