...
import { getPatientDashboard, getPatientMedicalHistory, getVisitDetails, getPatientNotifications, markNotificationAsRead, getPatientMessages, sendMessage, markMessageAsRead } from './patientPortalData';
...
describe('Patient Portal Data Service', () => {
    ...
    describe('sendMessage', () => {
        it('should send message successfully', async () => {
            const result = await sendMessage('portal-user-id', 'patient-id', 'Test Subject', 'Test message body', 'normal');
            expect(result).toBeNull();
        });
        it('should send message with parent for threading', async () => {
            const result = await sendMessage('portal-user-id', 'patient-id', 'Re: Test Subject', 'Reply message', 'normal', 'parent-message-id');
            expect(result).toBeNull();
        });
    });
