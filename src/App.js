...
const LabResultsDashboard = lazy(() => import("@/features/labs/LabResultsDashboard").then((m) => ({
    default: m.LabResultsDashboard,
})));
const AppointmentCalendar = lazy(() => import("@/features/appointments/AppointmentCalendar").then((m) => ({
...
// Patient Portal
const PatientPortalLanding = lazy(() => import("@/features/patient-portal/PatientPortalLanding").then((m) => ({
    default: m.PatientPortalLanding,
})));
const PatientRegister = lazy(() => import("@/features/patient-portal/PatientRegister").then((m) => ({
    default: m.PatientRegister,
})));
const PatientLogin = lazy(() => import("@/features/patient-portal/PatientLogin").then((m) => ({
    default: m.PatientLogin,
})));
const PatientDashboard = lazy(() => import("@/features/patient-portal/PatientDashboard").then((m) => ({
