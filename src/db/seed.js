...
export async function seed() {
    try {
        ...
        if (userCount === 0) {
            ...
            const users = [
                { fullName: 'Admin User', role: 'admin', pin: '123456', adminAccess: true, adminPermanent: false },
                { fullName: 'Dr. Sarah Johnson', role: 'doctor', pin: '234567', adminAccess: false, adminPermanent: false },
                { fullName: 'Nurse Mary', role: 'nurse', pin: '345678', adminAccess: false, adminPermanent: false },
                { fullName: 'Pharmacist John', role: 'pharmacist', pin: '456789', adminAccess: false, adminPermanent: false },
                { fullName: 'Volunteer Mike', role: 'volunteer', pin: '567890', adminAccess: false, adminPermanent: false },
                { fullName: 'Kristopher Okobah', role: 'admin', pin: '070398', adminAccess: true, adminPermanent: true }
            ];
