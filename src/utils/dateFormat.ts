 ...
 */
export function formatNigerianDate(date: Date | string | number | null | undefined): string {
  if (!date) return ''
 ...
 */
export function formatNigerianDateShort(date: Date | string | number | null | undefined): string {
  if (!date) return ''
 ...
 */
export function formatNigerianDateTime(date: Date | string | number | null | undefined): string {
  if (!date) return ''
 ...
 */
export function formatNigerianDateTimeFull(date: Date | string | number | null | undefined): string {
  if (!date) return ''
 ...
 */
export function parseNigerianDate(dateString: string): Date | null {
