...
export interface EventStaffAssignment {
  ...
  station?: 'registration' | 'vitals' | 'consult' | 'pharmacy' | 'lab' | 'education'
...
export interface PatientFlag {
  ...
  patient_id: string
  visit_id?: string
  flag_type: 'escalate_to_doctor' | 'recheck_vitals' | 'pharmacy_query' | 'lab_pending' | 'urgent' | 'follow_up_needed'
...
export interface FollowUpSchedule {
  ...
  follow_up_type: 'chronic_disease' | 'medication_refill' | 'test_results' | 'post_treatment' | 'general_checkup'
  reason: string
