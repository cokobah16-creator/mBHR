...
- ✅ Your API key saved: `re_YOUR_RESEND_API_KEY`
...
4. Value: `re_YOUR_RESEND_API_KEY`
5. Click Save
...
```bash
npx supabase secrets set RESEND_API_KEY=re_YOUR_RESEND_API_KEY --project-ref dlogqxzejroeyivfmgcv
```
