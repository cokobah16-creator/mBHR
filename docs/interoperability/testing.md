...
1. applies `supabase/migrations-deferred/20260926110000_interop_foundation.sql` twice (it must be
   idempotent);
2. runs `supabase/migrations-deferred/tests/interop_foundation.test.sql` with `pg_prove`
