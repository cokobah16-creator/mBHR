...
| `supabase/tests/interop_phase2.test.sql` | 227 | Phase 2, in ten sections (below) |
...
psql -v ON_ERROR_STOP=1 -d interop_t -f supabase/migrations/20260926130000_interop_phase2.sql
psql -d interop_t -c 'CREATE EXTENSION IF NOT EXISTS pgtap WITH SCHEMA extensions'
pg_prove -d interop_t supabase/tests/interop_foundation.test.sql supabase/tests/interop_phase2.test.sql
```
