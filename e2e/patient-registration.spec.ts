...
test.describe('Patient Registration Flow', () => {
  ...
  test('should navigate to registration page from dashboard', async ({ page }) => {
  ...
  test('should show phone validation error for invalid format', async ({ page }) => {
    await page.goto('/register')
  ...
  test('should allow registration with email instead of phone', async ({ page }) => {
    await page.goto('/register')
